...
| CI Visibility | Dedicated CI support | Dedicated CI support | Dedicated CI support | Data uploads plus discovery and synchronous CI API responses | Full Python test integration experiment in progress |
...
| Data Streams Monitoring | queued | queued | queued | Agent broker collection retained; SDK data separate | None yet |
