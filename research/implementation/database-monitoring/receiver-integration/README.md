...
The [development stack](../otlp-intake/dev-stack/README.md) provisions these roles
and extensions. In one terminal, open a loopback forward using its explicit context:
...
The script reads `dbm-otlp-dev/postgres:password` using `kind-otel-dd`.
